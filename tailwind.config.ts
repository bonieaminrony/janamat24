  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        ui: ["'Noto Sans Bengali'", "sans-serif"],
        bangla: ["'Hind Siliguri'", "'Noto Serif Bengali'", "sans-serif"],
        bijoy: ["'SutonnyMJ'", "Arial", "sans-serif"],
      },
      colors: {
        ...
        featured: {
          bg: "hsl(var(--featured-bg))",
          text: "hsl(var(--featured-text))",
        },
        categoryBadge: {
          DEFAULT: "hsl(var(--category-badge))",
          text: "hsl(var(--category-badge-text))",
        },
